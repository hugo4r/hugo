...
# test_that('wrong type of overwrite_parameters',{
#   tmp <- getOption("hugo.know_summary_parameters")
#   options(hugo.know_summary_parameters = F)
#   f <- file()
#   g <- file()
#   options(hugo.connection_in = f)
#   options(hugo.connection_out = g)
#   ans <- paste(c('pdf',"TRUE",'NULL', "5", "2", "iris", "iris"),collapse = '\n')
#   write(ans,f)
#
#   expect_error(hugo_summarise_data(data = iris,  overwrite_parameters = "as") )
#   expect_error(hugo_summarise_data(data = cars,  overwrite_parameters = 3))
#
#   options(hugo.connection_in = stdin())
#   options(hugo.connection_out = stdout())
#   options(hugo.know_summary_parameters = tmp)
...
#
#
# test_that('wrong type of input parameters ',{
#   tmp <- getOption("hugo.know_summary_parameters")
#   options(hugo.know_summary_parameters = F)
#   f <- file()
#   g <- file()
#   options(hugo.connection_in = f)
#   options(hugo.connection_out = g)
#   ans <- paste(c('ooo',"TRUE",'NULL', "5", "2", "iris", "iris"),collapse = '\n')
#   write(ans,f)
#
#   expect_error(hugo_summarise_data(data = iris, used_saved_params = TRUE, overwrite_parameters = TRUE) )
#   expect_error(hugo_summarise_data(data = cars, used_saved_params = TRUE, overwrite_parameters = TRUE))
#
#   options(hugo.connection_in = stdin())
#   options(hugo.connection_out = stdout())
#   options(hugo.know_summary_parameters = tmp)
...
#
#
# test_that('wrong type of input parameters replace ',{
#   tmp <- getOption("hugo.know_summary_parameters")
#   options(hugo.know_summary_parameters = F)
#   f <- file()
#   g <- file()
#   options(hugo.connection_in = f)
#   options(hugo.connection_out = g)
#   ans <- paste(c('html',"5",'NULL', "5", "2", "iris", "iris"),collapse = '\n')
#   write(ans,f)
#
#   expect_error(hugo_summarise_data(data = iris, used_saved_params = TRUE, overwrite_parameters = TRUE) )
#   expect_error(hugo_summarise_data(data = cars, used_saved_params = TRUE, overwrite_parameters = TRUE))
...
#
#
# test_that('wrong type of input parameters replace v2 ',{
#   tmp <- getOption("hugo.know_summary_parameters")
#   options(hugo.know_summary_parameters = F)
#   f <- file()
#   g <- file()
#   options(hugo.connection_in = f)
#   options(hugo.connection_out = g)
#   ans <- paste(c('html',"FALSE",'NULL', "5", "2", "iris", "iris"),collapse = '\n')
#   write(ans,f)
#
#   expect_error(hugo_summarise_data(data = iris, used_saved_params = TRUE, overwrite_parameters = TRUE) )
#   expect_error(hugo_summarise_data(data = cars, used_saved_params = TRUE, overwrite_parameters = TRUE))
...
#
#
# test_that('wrong type of input parameters varables ',{
#   tmp <- getOption("hugo.know_summary_parameters")
#   options(hugo.know_summary_parameters = F)
#   f <- file()
#   g <- file()
#   options(hugo.connection_in = f)
#   options(hugo.connection_out = g)
#   ans <- paste(c('html',"FALSE",'6', "5", "2", "iris", "iris"),collapse = '\n')
#   write(ans,f)
#
#   expect_error(hugo_summarise_data(data = iris, used_saved_params = TRUE, overwrite_parameters = TRUE) )
#   expect_error(hugo_summarise_data(data = cars, used_saved_params = TRUE, overwrite_parameters = TRUE))
